...
static void rna_NodeTree_foreach_nodeclass(Scene *UNUSED(scene), void *calldata, bNodeClassCallback func)
{
...
static void rna_def_node_socket(BlenderRNA *brna)
{
	...
	RNA_def_property_ui_text(prop, "Static Type", "Socket data type (use with care)");
...
static void rna_def_node(BlenderRNA *brna)
{
	...
	RNA_def_property_enum_default(prop, NODE_CUSTOM);
	RNA_def_property_flag(prop, PROP_REGISTER_OPTIONAL);
	RNA_def_property_ui_text(prop, "Static Type", "Node type (use with care)");
