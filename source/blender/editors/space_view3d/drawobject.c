                            ...
                            const char dt, const unsigned char ob_wire_col[4], const short dflag)
{
	...
	const bool is_presel = ((scene->toolsettings->presel_flags & SCE_PRESEL_ENABLED) != 0) && ((ob->pflag & BA_PRESELECT) != 0);
